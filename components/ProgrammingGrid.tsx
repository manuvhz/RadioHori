...
const SCHEDULE: DailySchedule[] = [
  ...
  { day: 'Viernes', slots: [{ name: 'Entrenamiento', theme: ProgramTheme.ENTERTAINMENT, Icon: MusicIcon, audioSrc: '/audio/entrenamiento.mp3' }, { name: 'Música', theme: ProgramTheme.MUSIC, Icon: MusicIcon }, { name: 'Tecnología', theme: ProgramTheme.SCIENCE, Icon: FlaskIcon }] },
